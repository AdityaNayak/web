...
<div class="grid-container">
	<div class="grid-x align-center b-ws-top">
		<div class="small-12 medium-10 large-8 b-ws-top-p">
			...
			<p class="h3 b-ws-top">My time is limited.</p>
			<p class="bc">So is yours.</p>
		</div>
	</div>
</div>
<div class="lgbg">
			...
			<div class="small-12 medium-10 large-8 cell b-ws-top-p b-ws-bottom-p">
				...
				<div class="grid-x grid-padding-x">
					<div class="small-3 cell">
						Invisible human cooperation networks.
					</div>
					...
					<p class="h4 m-ws-top-p nm">3. Discovering Individual Consciousness.</p>
					<p class="nm">Less than binary consciousness breeds myopia. Myopic individuals strain cooperation networks. The future demands a new man.</p>
	...
	<div class="grid-container">
		<div class="grid-x align-center">
			<div class="small-12 medium-10 large-8 cell b-ws-top-p b-ws-bottom">
				...
				<p class="h4 nm bkc m-ws-top-p">Attempting Being.</p>
				<p class="">In truth. In reality. In the moment.</p>
				<p class="s-ws-top-p nm">Full-time Monk. Part-time Entrepreneur.</p>
